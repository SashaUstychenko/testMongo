...
namespace WORK_IN_FILE
{
  ...
  void func5441()
  {
    std::ifstream file("/home/zirer/zirerfile/fileC++/testMongo/format.txt");
    if(file.is_open())
    {
      std::string name;
      int age;
      std::string occupation;
      file >> name >> name >> age >> occupation >> occupation;
  ...
  void func1eee()
  {
    std::ofstream file("/home/zirer/zirerfile/fileC++/testMongo/format.txt");
    if(file.is_open())
    {
      file<<"Name: "<<"Sasha"<<"\n"
          <<"Age: "<<"20"<<"\n"
          <<"Occupation: "<<"Software Developer"<<std::endl;
      file.close();
    }
    else
    {
  ...
  {
    char buffer[128];
    std::ifstream file("/home/zirer/zirerfile/fileC++/testMongo/test.txt");
    if (file.is_open())
    {
      file.read(buffer,sizeof(buffer));      
      std::cout<<"data of file : "<<buffer<<std::endl;
      file.close();
    }
    else
    {
  ...
  void fdsdsunc1()
  {
    ...
    std::ofstream file("/home/zirer/zirerfile/fileC++/testMongo/test.txt");
    if (file.is_open())
    {
  ...
  bool isDirectory(std::string& path)
  {
    ...
    else if (info.st_mode & S_IFDIR)// перевірка на теку коли це істина;
    {
      return true;    
    }
    else
  ...
  void func3456534()
  {
    std::string path = "/home/zirer/zirerfile/fileC++/testMongo/main.cpp";
    if(isDirectory(path))
    {
    ...
    {
      std::cerr<<"Path isn'n a directory"<<std::endl;
    }
  }

  void funcews1()
  {
    std::ifstream file("/home/zirer/zirerfile/fileC++/testMongo/tester.bin",std::ios::binary);
    if(file.is_open())
    {
      int data;
  ...
  void funcdd1()
  {
    std::ofstream file("/home/zirer/zirerfile/fileC++/testMongo/tester.bin",std::ios_base::app);
    if(file.is_open())
    {
      int data = 12345;
  ...
  void func3421()
  {
    std::ifstream file("/home/zirer/zirerfile/fileC++/testMongo/main.cpp");
    if(file.is_open())
    {
  ...
  void func002()
  {  
    const char* file_name = "/home/zirer/zirerfile/fileC++/testMongo/test.txt";
  ...
  void func1456()
  {
    const char* new_name = "/home/zirer/zirerfile/fileC++/testMongo/test.txt";
    const char* old_name = "/home/zirer/zirerfile/fileC++/testMongo/tist.txt";
    if (rename(old_name,new_name)==0)
    {
      std::cout<<"FIle renemed successfully"<<std::endl;      
  ...
  long func1c(const std::string& filename)
  {
    std::ifstream file(filename,std::ifstream::ate | std::ifstream::binary);
    return file.tellg();//return file size 
  }
  void func1sdf()
  {
    std::string filename {"/home/zirer/zirerfile/fileC++/testMongo/test.txt"};
    long size = func1c(filename);
    if (size != -1)
    {
  ...
  void func1221()
  {
    std::ofstream file ("/home/zirer/zirerfile/fileC++/testMongo/test.txt",std::ios_base::app);
    if(file.is_open())
    {
      file<<"hello from new file"<<std::endl;
      file.close();
    }
    else
    {
  ...
  void func111()
  {
    std::vector<std::string>lines = {"sasha 1line","vova two line","vita three line"};
    std::ofstream file ("/home/zirer/zirerfile/fileC++/testMongo/test.txt");
    if (file.is_open())
    {
  ...
  void func11()
  {
    ...
    {
      std::cout<<"unabled todirectory created!!!"<<std::endl;
   
    }
  }
  bool bfunc1(std::string filename)
  {
  ...
  void func00001()
  {
    std::string filename = "/home/zirer/zirerfile/fileC++/testMongo/tester.txt";
    if (bfunc1(filename))
    {
  ...
  //create file(or if file was created) a writing to this file
  void func0001()
  {
    std::ofstream file ("/home/zirer/zirerfile/fileC++/testMongo/tester.txt");
    if(file.is_open())
    {
      file<<"hello from new file"<<std::endl;
      file.close();
